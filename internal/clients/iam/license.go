...
func GenerateLicenseObservation(info *LicenseInfo, installedHash string) iamv1alpha1.LicenseObservation {
	if info == nil {
		return iamv1alpha1.LicenseObservation{InstalledHash: installedHash}
	}

	return iamv1alpha1.LicenseObservation{
...
func IsLicenseUpToDate(cr *iamv1alpha1.License, currentHash string) bool {
