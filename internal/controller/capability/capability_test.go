...
import (
	...
	capabilitymocks "github.com/genesary/provider-sonatype-nexus/test/mocks/capability"
)
	...
	tests := []struct {
		...
		},
		{
			...
			mockSetup: func(mc *capabilitymocks.MockCapabilityClient) {
				mc.GetCapabilityFn = func(_ context.Context, _ string) (*nexussdk.Capability, error) {
...
func TestCreate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			cr:   newTestCapability("cap", "DockerBearerTokenRealm"),
			mockSetup: func(mc *capabilitymocks.MockCapabilityClient) {
				mc.CreateCapabilityFn = func(_ context.Context, _ nexussdk.CapabilityCreate) (*nexussdk.Capability, error) {
...
func TestUpdate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			cr:   newTestCapabilityWithID("cap", "DockerBearerTokenRealm", "abc123"),
			mockSetup: func(mc *capabilitymocks.MockCapabilityClient) {
				mc.UpdateCapabilityFn = func(_ context.Context, _ string, _ nexussdk.CapabilityUpdate) error {
					return nil
				}
			},
			wantErr: false,
...
func TestDelete(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			cr:   newTestCapabilityWithID("cap", "DockerBearerTokenRealm", "abc123"),
			mockSetup: func(mc *capabilitymocks.MockCapabilityClient) {
				mc.DeleteCapabilityFn = func(_ context.Context, _ string) error {
					return nil
				}
			},
			wantErr: false,
