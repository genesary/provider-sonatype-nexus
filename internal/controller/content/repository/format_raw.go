...
func (h *RawHandler) Observe(ctx context.Context, client *pkgrepository.RepositoryService, name, repoType string, repoCR *repositoryv1alpha1.Repository) (exists, upToDate bool) {
	switch repoType {
	case repoTypeHosted:
		return observeRepo(name, client.Raw.Hosted.Get, h.isHostedUpToDate, repoCR)
	case repoTypeProxy:
		return observeRepo(name, client.Raw.Proxy.Get, h.isProxyUpToDate, repoCR)
	case repoTypeGroup:
		return observeRepo(name, client.Raw.Group.Get, h.isGroupUpToDate, repoCR)
	}
...
func (h *RawHandler) Create(ctx context.Context, client *pkgrepository.RepositoryService, repoCR *repositoryv1alpha1.Repository, repoType string) error {
	switch repoType {
	case repoTypeHosted:
		return client.Raw.Hosted.Create(h.generateHosted(repoCR))
	case repoTypeProxy:
		return client.Raw.Proxy.Create(h.generateProxy(ctx, repoCR))
	case repoTypeGroup:
		return client.Raw.Group.Create(h.generateGroup(repoCR))
	}
...
func (h *RawHandler) Update(ctx context.Context, client *pkgrepository.RepositoryService, name string, repoCR *repositoryv1alpha1.Repository, repoType string) error {
	switch repoType {
	case repoTypeHosted:
		return client.Raw.Hosted.Update(name, h.generateHosted(repoCR))
	case repoTypeProxy:
		return client.Raw.Proxy.Update(name, h.generateProxy(ctx, repoCR))
	case repoTypeGroup:
		return client.Raw.Group.Update(name, h.generateGroup(repoCR))
	}
...
func (h *RawHandler) Delete(ctx context.Context, client *pkgrepository.RepositoryService, name, repoType string) error {
	switch repoType {
	case repoTypeHosted:
		return client.Raw.Hosted.Delete(name)
	case repoTypeProxy:
		return client.Raw.Proxy.Delete(name)
	case repoTypeGroup:
		return client.Raw.Group.Delete(name)
	}
