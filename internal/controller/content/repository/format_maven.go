...
func (h *MavenHandler) Observe(ctx context.Context, client *pkgrepository.RepositoryService, name, repoType string, repoCR *repositoryv1alpha1.Repository) (exists, upToDate bool) {
	switch repoType {
	case repoTypeHosted:
		return observeRepo(name, client.Maven.Hosted.Get, h.isHostedUpToDate, repoCR)
	case repoTypeProxy:
		return observeRepo(name, client.Maven.Proxy.Get, h.isProxyUpToDate, repoCR)
	case repoTypeGroup:
		return observeRepo(name, client.Maven.Group.Get, h.isGroupUpToDate, repoCR)
	}
...
func (h *MavenHandler) Create(ctx context.Context, client *pkgrepository.RepositoryService, repoCR *repositoryv1alpha1.Repository, repoType string) error {
	switch repoType {
	case repoTypeHosted:
		return client.Maven.Hosted.Create(h.generateHosted(repoCR))
	case repoTypeProxy:
		return client.Maven.Proxy.Create(h.generateProxy(ctx, repoCR))
	case repoTypeGroup:
		return client.Maven.Group.Create(h.generateGroup(repoCR))
	}
...
func (h *MavenHandler) Update(ctx context.Context, client *pkgrepository.RepositoryService, name string, repoCR *repositoryv1alpha1.Repository, repoType string) error {
	switch repoType {
	case repoTypeHosted:
		return client.Maven.Hosted.Update(name, h.generateHosted(repoCR))
	case repoTypeProxy:
		return client.Maven.Proxy.Update(name, h.generateProxy(ctx, repoCR))
	case repoTypeGroup:
		return client.Maven.Group.Update(name, h.generateGroup(repoCR))
	}
...
func (h *MavenHandler) Delete(ctx context.Context, client *pkgrepository.RepositoryService, name, repoType string) error {
	switch repoType {
	case repoTypeHosted:
		return client.Maven.Hosted.Delete(name)
	case repoTypeProxy:
		return client.Maven.Proxy.Delete(name)
	case repoTypeGroup:
		return client.Maven.Group.Delete(name)
	}
